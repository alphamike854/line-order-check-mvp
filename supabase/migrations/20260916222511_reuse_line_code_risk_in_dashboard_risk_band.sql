-- Optimize dashboard_risk_snapshot risk_band gross_received.
--
-- risk_band previously re-aggregated public.order_items independently.
-- Reuse the already materialized current-Round line_code_risk rowset
-- instead, preserving the existing risk_band output contract.
--
-- Pre-change evidence:
--   planner cost: 3594.81
--   duplicate order_items estimated rows: 11344
--
-- Candidate evidence:
--   planner cost: 576.43
--   order_items access paths: 2 -> 1
--   semantic equivalence: PASS across current SOUTHEAST line groups
--   all tested risk_band mismatch counts: 0
--
-- Do not modify the historical migration that originally defined
-- dashboard_risk_snapshot; this migration replaces the function forward.
